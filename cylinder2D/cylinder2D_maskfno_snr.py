...
# @Author  : zhaoxiaoyu
# @File    : cylinder2D_maskfno_snr.py
import torch
...
args = parses()
args.exp = 'recon_fno_regre_cylinder_8_snr80'
args.epochs = 300
args.batch_size = 16
print(args)
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/cylinder2D/logs/ckpt/recon_fno_regre_cylinder_2/best_epoch_299_loss_0.00035984.pth'
