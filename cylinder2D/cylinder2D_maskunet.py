...
args = parses()
args.exp = 'recon_unet_regre_cylinder_32'
args.epochs = 300
args.batch_size = 16
print(args)
...
def train():
    ...
    # Build data loader
    train_dataset = CylinderObserveDataset(index=[i for i in range(3500)])
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, num_workers=4, shuffle=True)
    val_dataset = CylinderObserveDataset(index=[i for i in range(3500, 4250)])
