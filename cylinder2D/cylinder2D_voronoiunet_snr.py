...
# @Author  : zhaoxiaoyu
# @File    : cylinder2D_voronoiunet_snr.py
import torch
...
args = parses()
args.exp = 'recon_voronoiunet_cylinder_8_snr80'
args.epochs = 300
args.batch_size = 16
print(args)
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/cylinder2D/logs/ckpt/recon_voronoiunet_cylinder_8/best_epoch_298_loss_0.00019697.pth'
