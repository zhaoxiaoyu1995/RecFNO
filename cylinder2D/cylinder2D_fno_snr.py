...
from field_recon.model.fno import FNORecon
from field_recon.data.dataset import CylinderSNRDataset
...
args = parses()
args.exp = 'recon_fno_cylinder_8_snr80'
args.epochs = 300
args.batch_size = 16
print(args)
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/cylinder2D/logs/ckpt/recon_fno_cylinder_8_snr20/best_epoch_240_loss_0.03196744.pth'

    # Define data loader
    test_dataset = CylinderSNRDataset(index=index, snr=True, SNRdB=20, test=True)
