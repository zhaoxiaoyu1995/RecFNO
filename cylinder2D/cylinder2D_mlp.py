...
def train():
    ...
    net = MLP(layers=[2, 128, 1280, 4800, 21504]).cuda()
...
def test(index=[i for i in range(4250, 5000)]):
    # Path of trained network
    args.snapshot = '/mnt/zhaoxiaoyu/ARE/field_recon/cylinder2D/logs/ckpt/recon_mlp_cylinder_2/best_epoch_496_loss_0.00172044.pth'
