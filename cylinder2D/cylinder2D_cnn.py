...
def train():
    ...
    net = CNNRecon(sensor_num=32, fc_size=(7, 12)).cuda()
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/cylinder2D/logs/ckpt/recon_cnn_cylinder_2/best_epoch_299_loss_0.00018147.pth'
