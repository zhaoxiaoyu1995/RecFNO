...
args = parses()
args.exp = 'recon_voronoiunet_daycy_25_display'
args.epochs = 300
args.batch_size = 16
print(args)
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/darcy/logs/ckpt/recon_voronoiunet_daycy_36/best_epoch_212_loss_0.00514733.pth'
