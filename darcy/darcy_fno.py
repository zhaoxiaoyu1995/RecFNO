...
def train():
    ...
    net = FNORecon(sensor_num=36, fc_size=(16, 16), out_size=(128, 128), modes1=18, modes2=18, width=32).cuda()
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/darcy/logs/ckpt/recon_fno_darcy_25/best_epoch_80_loss_0.00730099.pth'
    ...
    net = FNORecon(sensor_num=25, fc_size=(16, 16), out_size=(128, 128), modes1=18, modes2=18, width=32).cuda()
