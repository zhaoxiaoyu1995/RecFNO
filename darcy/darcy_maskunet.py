...
args = parses()
args.exp = 'recon_uetreg_daycy_36'
args.epochs = 300
args.batch_size = 16
print(args)
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/darcy/logs/ckpt/recon_uetreg_daycy_36/best_epoch_298_loss_0.00606795.pth'
