...
args = parses()
args.exp = 'recon_fno_regre_noaa_256'
args.epochs = 300
args.batch_size = 16
print(args)
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/NOAA/logs/ckpt/recon_fno_regre_noaa_256/best_epoch_274_loss_0.00548088.pth'
