...
def train():
    ...
    net = CNNRecon(sensor_num=256, fc_size=(18, 36)).cuda()
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/NOAA/logs/ckpt/recon_cnn_noaa_256/best_epoch_279_loss_0.00653344.pth'
