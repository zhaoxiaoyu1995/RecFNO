...
args = parses()
args.exp = 'recon_voronoiunet_noaa_32'
args.epochs = 300
args.batch_size = 16
print(args)
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/NOAA/logs/ckpt/recon_voronoiunet_noaa_32/best_epoch_31_loss_0.00796915.pth'
