...
df = pd.read_excel('./data/results.xlsx', engine='openpyxl', index_col=0, sheet_name='cylinder_snr_clear')
data = df.to_numpy()
...
plt.ylabel("MAE")
# plt.show()
plt.savefig('snr_cylinder_clear.pdf', bbox_inches='tight', pad_inches=0)