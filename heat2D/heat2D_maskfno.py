...
args = parses()
args.exp = 'recon_fno_regre_heat_4'
args.epochs = 300
args.batch_size = 8
print(args)
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/heat2D/logs/ckpt/recon_fno_regre_heat_36/best_epoch_297_loss_0.00022557.pth'
