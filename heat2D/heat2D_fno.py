...
def train():
    ...
    net = FNORecon(sensor_num=25, fc_size=(12, 12), out_size=(200, 200), modes1=50, modes2=50, width=32).cuda()

    # Build data loader
    train_dataset = HeatDataset(index=[i for i in range(4000)])
...
def test(index):
    ...
    net = FNORecon(sensor_num=36, fc_size=(12, 12), out_size=(200, 200), modes1=36, modes2=36, width=32).cuda()
