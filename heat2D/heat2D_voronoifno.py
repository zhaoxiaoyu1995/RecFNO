...
args = parses()
args.exp = 'recon_voronoifno_heat_25_4'
args.epochs = 300
args.batch_size = 8
print(args)
...
def train():
    ...
    net = VoronoiFNO2d(modes1=4, modes2=4, width=32, in_channels=4).cuda()
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/heat2D/logs/ckpt/recon_voronoifno_heat_36/best_epoch_295_loss_0.00005883.pth'
