...
def train():
    ...
    net = CNNRecon(sensor_num=4, fc_size=(12, 12)).cuda()
...
def test(index):
    ...
    args.snapshot = '/home/ubuntu/zhaoxiaoyu/ARE/field_recon/heat2D/logs/ckpt/recon_cnn_heat_36/best_epoch_292_loss_0.00039711.pth'
